...
final class InterpolatedSpriteBuilder {
    ...
    public static InterpolatedResult interpolate(NativeImage frameSheet, int frameWidth, int frameHeight,
        int frameRowCount, List<SpriteContents.FrameInfo> frames) {
    ...
    private static void blend(NativeImage source, int srcX, int srcY, NativeImage dest, int destX, int destY,
        int frameWidth, int frameHeight, float alpha) {
