...
public class LayoutsTest {
    ...
    private static class TestCase {
        ...
        TestCase(LayoutContext context, List<LytBlock> children, int x, int y, int availableWidth, int paddingLeft,
            int paddingTop, int paddingRight, int paddingBottom, int gap, LytRect expectedOutput,
            List<LytRect> expectedChildBounds) {
        ...
        return Stream.of(
            ...
            Arguments.of(
                ...
                new TestCase(
                    ...
                    List.of(new LytRect(40, 96, 30, 20)))),
            Arguments.of(
                "Two children",
                new TestCase(
                    context,
    ...
    void testHorizontalLayout(String testName, TestCase testCase) {
        var result = Layouts.horizontalLayout(
            ...
            testCase.paddingLeft,
            testCase.paddingTop,
            testCase.paddingRight,
            testCase.paddingBottom,
            testCase.gap,
            AlignItems.START);
