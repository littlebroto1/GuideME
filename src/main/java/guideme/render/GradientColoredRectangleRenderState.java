 ...
 */
record GradientColoredRectangleRenderState(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2f pose, int x0,
    int y0, int x1, int y1, int colTL, int colTR, int colBR, int colBL, @Nullable ScreenRectangle scissorArea,
    @Nullable ScreenRectangle bounds) implements GuiElementRenderState {

    public GradientColoredRectangleRenderState(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2f pose,
        int x0, int y0, int x1, int y1, int colUL, int colTR, int colBR, int colBL,
